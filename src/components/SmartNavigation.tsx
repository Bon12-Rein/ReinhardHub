...
const SmartNavigation: React.FC<SmartNavigationProps> = ({ onNavigate }) => {
  ...
  const sections = [
    ...
    { id: 'blog', name: 'Blog', keywords: ['blog', 'articles', 'insights', 'posts', 'news'] },
    { id: 'digital-products', name: 'Digital Products', keywords: ['products', 'courses', 'ebooks', 'resources', 'tools'] },
